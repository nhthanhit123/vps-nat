...
// Send Telegram notification when admin accesses any page
        ...
        <aside id="sidebar" class="sidebar-gradient text-white w-64 min-h-screen fixed lg:relative lg:translate-x-0 sidebar-mobile z-30">
            <div class="p-6">
                ...
                <nav class="space-y-2">
                    ...
                    <a href="seo.php" class="sidebar-item <?= $page == 'seo' ? 'active' : '' ?> flex items-center space-x-3 px-4 py-3 rounded-lg text-gray-300 hover:text-white">
                        <i class="fas fa-search w-5"></i>
                        <span>Cài Đặt SEO</span>
                    </a>
                    <a href="notifications.php" class="sidebar-item <?= $page == 'notifications' ? 'active' : '' ?> flex items-center space-x-3 px-4 py-3 rounded-lg text-gray-300 hover:text-white">
                        <i class="fas fa-bell w-5"></i>
                        <span>Thông Báo</span>
                    </a>
                    <a href="contact.php" class="sidebar-item <?= $page == 'contact' ? 'active' : '' ?> flex items-center space-x-3 px-4 py-3 rounded-lg text-gray-300 hover:text-white">
