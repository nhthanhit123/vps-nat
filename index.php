...
<!-- Hero Section -->
<section class="gradient-secondary text-white py-20 relative overflow-hidden">
    ...
    <div class="container mx-auto px-4 relative z-10">
        <div class="max-w-4xl mx-auto text-center">
            ...
            <p class="text-xl md:text-2xl mb-8 text-teal-50 max-w-2xl mx-auto">
                Cung Cấp Dịch Vụ VPS Giá Rẻ Nhất Thị Trường <br> Hỗ Trợ Kĩ Thuật 24/7
            </p>
...
<!-- CTA Section -->
<section class="py-20 gradient-secondary text-white relative overflow-hidden text-center">
    <div class="container mx-auto px-4">
