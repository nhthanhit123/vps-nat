...
<section class="gradient-primary text-white py-12 relative overflow-hidden">
    ...
    <div class="container mx-auto px-4 relative z-10">
        <div class="text-center">
            <h1 class="text-3xl md:text-4xl font-bold mb-4">Đặt mua VPS</h1>
            <p class="text-lg text-teal-100">Hoàn tất thông tin để kích hoạt VPS của bạn ngay lập tức</p>
        </div>
    </div>
</section>
...
<section class="py-4 bg-white border-b">
    <div class="container mx-auto px-4">
        <nav class="flex items-center space-x-2 text-sm">
            <a href="index.php" class="text-gray-500 hover:text-teal-600 smooth-transition">Trang chủ</a>
            <span class="text-gray-400">/</span>
            <a href="packages.php" class="text-gray-500 hover:text-teal-600 smooth-transition">Gói VPS</a>
            <span class="text-gray-400">/</span>
            ...
            <div class="grid grid-cols-1 lg:grid-cols-3 gap-8">
                ...
                <div class="lg:col-span-2">
                    <div class="bg-white rounded-2xl shadow-sm p-8 mb-8">
                        <div class="flex items-center mb-6">
                            <div class="w-12 h-12 bg-gradient-to-r <?= ($package['category'] ?? 'nat') === 'cheap' ? 'from-green-600 to-green-400' : 'from-teal-600 to-teal-400' ?> rounded-lg flex items-center justify-center mr-4">
                                <i class="fas fa-server text-white text-xl"></i>
                            </div>
                            <div>
                                <h2 class="text-2xl font-bold text-gray-900"><?= htmlspecialchars($package['name']) ?></h2>
                                <div class="flex items-center space-x-2">
                                    <span class="bg-<?= ($package['category'] ?? 'nat') === 'cheap' ? 'green' : 'teal' ?>-100 text-<?= ($package['category'] ?? 'nat') === 'cheap' ? 'green' : 'teal' ?>-800 px-3 py-1 rounded-full text-sm font-semibold">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mb-8">
                            <div class="space-y-4">
                                <div class="flex items-center p-4 bg-gray-50 rounded-lg">
                                    <div class="w-10 h-10 bg-<?= ($package['category'] ?? 'nat') === 'cheap' ? 'green' : 'teal' ?>-100 rounded-lg flex items-center justify-center mr-3">
                                        <i class="fas fa-microchip text-<?= ($package['category'] ?? 'nat') === 'cheap' ? 'green' : 'teal' ?>-600"></i>
                                    </div>
                                    <div>
                                ...
                                <div class="flex items-center p-4 bg-gray-50 rounded-lg">
                                    <div class="w-10 h-10 bg-<?= ($package['category'] ?? 'nat') === 'cheap' ? 'green' : 'teal' ?>-100 rounded-lg flex items-center justify-center mr-3">
                                        <i class="fas fa-memory text-<?= ($package['category'] ?? 'nat') === 'cheap' ? 'green' : 'teal' ?>-600"></i>
                                    </div>
                                    <div>
                                ...
                                <div class="flex items-center p-4 bg-gray-50 rounded-lg">
                                    <div class="w-10 h-10 bg-<?= ($package['category'] ?? 'nat') === 'cheap' ? 'green' : 'teal' ?>-100 rounded-lg flex items-center justify-center mr-3">
                                        <i class="fas fa-hdd text-<?= ($package['category'] ?? 'nat') === 'cheap' ? 'green' : 'teal' ?>-600"></i>
                                    </div>
                                    <div>
                            ...
                            <div class="space-y-4">
                                <div class="flex items-center p-4 bg-gray-50 rounded-lg">
                                    <div class="w-10 h-10 bg-<?= ($package['category'] ?? 'nat') === 'cheap' ? 'green' : 'teal' ?>-100 rounded-lg flex items-center justify-center mr-3">
                                        <i class="fas fa-wifi text-<?= ($package['category'] ?? 'nat') === 'cheap' ? 'green' : 'teal' ?>-600"></i>
                                    </div>
                                    <div>
                                ...
                                <div class="flex items-center p-4 bg-gray-50 rounded-lg">
                                    <div class="w-10 h-10 bg-<?= ($package['category'] ?? 'nat') === 'cheap' ? 'green' : 'teal' ?>-100 rounded-lg flex items-center justify-center mr-3">
                                        <i class="fas fa-globe text-<?= ($package['category'] ?? 'nat') === 'cheap' ? 'green' : 'teal' ?>-600"></i>
                                    </div>
                                    <div>
                                ...
                                <div class="flex items-center p-4 bg-gray-50 rounded-lg">
                                    <div class="w-10 h-10 bg-<?= ($package['category'] ?? 'nat') === 'cheap' ? 'green' : 'teal' ?>-100 rounded-lg flex items-center justify-center mr-3">
                                        <i class="fas fa-shield-alt text-<?= ($package['category'] ?? 'nat') === 'cheap' ? 'green' : 'teal' ?>-600"></i>
                                    </div>
                                    <div>
                                        <div class="text-sm text-gray-500">Bảo mật</div>
                                        <div class="font-semibold">DDoS Protection</div>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="border-t pt-6">
                            <h3 class="text-lg font-semibold text-gray-900 mb-4">Tính năng nổi bật</h3>
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-3">
                                <div class="flex items-center text-gray-600">
                                    <i class="fas fa-check text-green-500 mr-2"></i>
                                    <span>Full quyền quản trị Root</span>
                                </div>
                                <div class="flex items-center text-gray-600">
                                    <i class="fas fa-check text-green-500 mr-2"></i>
                    ...
                    <div class="bg-white rounded-2xl shadow-sm p-8">
                        ...
                        <form method="POST" id="orderForm">
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
                                <div>
                                    <label class="block text-sm font-medium text-gray-700 mb-2">
                                        <i class="fas fa-desktop mr-1 text-<?= ($package['category'] ?? 'nat') === 'cheap' ? 'green' : 'teal' ?>-600"></i>
                                        Hệ điều hành <span class="text-red-500">*</span>
                                    </label>
                                    <select name="os_id" id="os_id" required
                                            class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-<?= ($package['category'] ?? 'nat') === 'cheap' ? 'green' : 'teal' ?>-500 focus:border-<?= ($package['category'] ?? 'nat') === 'cheap' ? 'green' : 'teal' ?>-500">
                                ...
                                <div>
                                    <label class="block text-sm font-medium text-gray-700 mb-2">
                                        <i class="fas fa-calendar mr-1 text-<?= ($package['category'] ?? 'nat') === 'cheap' ? 'green' : 'teal' ?>-600"></i>
                            ...
                            <button type="submit" 
                                    class="w-full bg-gradient-to-r from-<?= ($package['category'] ?? 'nat') === 'cheap' ? 'green' : 'teal' ?>-600 to-<?= ($package['category'] ?? 'nat') === 'cheap' ? 'green' : 'teal' ?>-400 hover:from-<?= ($package['category'] ?? 'nat') === 'cheap' ? 'green' : 'teal' ?>-700 hover:to-<?= ($package['category'] ?? 'nat') === 'cheap' ? 'green' : 'teal' ?>-500 text-white py-4 px-6 rounded-lg font-semibold smooth-transition hover-lift">
                ...
                <div class="lg:col-span-1">
                    <div class="bg-white rounded-2xl shadow-sm p-6 sticky top-6">
                        ...
                        <!-- Package Info -->
                        <div class="bg-gradient-to-br from-<?= ($package['category'] ?? 'nat') === 'cheap' ? 'green' : 'teal' ?>-50 to-<?= ($package['category'] ?? 'nat') === 'cheap' ? 'emerald' : 'blue' ?>-50 rounded-lg p-4 mb-6">
                            <div class="text-center mb-4">
                                <div class="text-2xl font-bold text-<?= ($package['category'] ?? 'nat') === 'cheap' ? 'green' : 'teal' ?>-600">
                            ...
                            <?php if ($package['original_price'] > $package['selling_price']): ?>
                                <div class="text-center">
                                    ...
                                    <div class="text-xs bg-green-100 text-green-800 px-2 py-1 rounded-full mt-1 inline-block">
                        ...
                        <div class="space-y-3 mb-6">
                            ...
                            <div class="border-t pt-3">
                                <div class="flex justify-between text-lg font-bold text-gray-900">
                                    <span>Tổng cộng:</span>
                                    <span id="total_price" class="text-teal-600">0 VNĐ</span>
                                </div>
                            </div>
                        </div>
...
document.getElementById('orderForm').addEventListener('submit', function(e) {
    ...
    const userBalance = <?= $_SESSION['balance'] ?>;
